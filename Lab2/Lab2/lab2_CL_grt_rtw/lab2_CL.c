...
void lab2_CL_step(void)
{
  ...
  if (rtmIsMajorTimeStep(lab2_CL_M)) {
    ...
    if (!(lab2_CL_M->Timing.clockTick0+1)) {
      rtsiSetSolverStopTime(&lab2_CL_M->solverInfo,
                            ((lab2_CL_M->Timing.clockTickH0 + 1) *
        lab2_CL_M->Timing.stepSize0 * 4294967296.0));
    } else {
      rtsiSetSolverStopTime(&lab2_CL_M->solverInfo,
                            ((lab2_CL_M->Timing.clockTick0 + 1) *
        lab2_CL_M->Timing.stepSize0 + lab2_CL_M->Timing.clockTickH0 *
        lab2_CL_M->Timing.stepSize0 * 4294967296.0));
    }
  }                                    /* end MajorTimeStep */
  ...
  if (rtmIsMajorTimeStep(lab2_CL_M)) {
    ...
    exitg1 = false;
    while ((!exitg1) && (k < 8)) {
      if (lab2_CL_DW.obj.inputVarSize.f1[k] != 1U) {
        for (k = 0; k < 8; k++) {
          lab2_CL_DW.obj.inputVarSize.f1[k] = 1U;
        }
     ...
     *  MATLABSystem: '<Root>/Transmit to Computer'
     */
    dataIn = (uint8_T)(currentTime < 0.0 ? (int32_T)(uint8_T)-(int8_T)(uint8_T)
                       -currentTime : (int32_T)(uint8_T)currentTime);
    MW_Serial_write(lab2_CL_DW.obj.port, &dataIn, 1.0,
                    lab2_CL_DW.obj.dataSizeInBytes);

    /* Step: '<Root>/Voltage Source' */
    currentTime = (((lab2_CL_M->Timing.clockTick1+lab2_CL_M->Timing.clockTickH1*
                     4294967296.0)) * 0.01);
  ...
  if (rtb_Product < 256.0) {
    if (rtb_Product >= 0.0) {
      lab2_CL_B.DataTypeConversion = (uint8_T)rtb_Product;
    } else {
      lab2_CL_B.DataTypeConversion = 0U;
    }
  } else {
    lab2_CL_B.DataTypeConversion = MAX_uint8_T;
  }

  if (rtmIsMajorTimeStep(lab2_CL_M)) {
    /* S-Function (arduinoanalogoutput_sfcn): '<S6>/PWM' */
    MW_analogWrite(lab2_CL_P.PWM_pinNumber, lab2_CL_B.DataTypeConversion);
  }
  ...
  if (rtmIsMajorTimeStep(lab2_CL_M)) {
    /* Matfile logging */
    rt_UpdateTXYLogVars(lab2_CL_M->rtwLogInfo, (lab2_CL_M->Timing.t));
  }                                    /* end MajorTimeStep */
  ...
  if (rtmIsMajorTimeStep(lab2_CL_M)) {
    ...
    {                                  /* Sample time: [0.0s, 0.0s] */
      if ((rtmGetTFinal(lab2_CL_M)!=-1) &&
          !((rtmGetTFinal(lab2_CL_M)-(((lab2_CL_M->Timing.clockTick1+
               lab2_CL_M->Timing.clockTickH1* 4294967296.0)) * 0.01)) >
            (((lab2_CL_M->Timing.clockTick1+lab2_CL_M->Timing.clockTickH1*
               4294967296.0)) * 0.01) * (DBL_EPSILON))) {
        rtmSetErrorStatus(lab2_CL_M, "Simulation finished");
      }
    }
     ...
     */
    if (!(++lab2_CL_M->Timing.clockTick0)) {
      ++lab2_CL_M->Timing.clockTickH0;
    }
...

    {
      ...
      if (!lab2_CL_M->Timing.clockTick1) {
        lab2_CL_M->Timing.clockTickH1++;
      }
    }
  }                                    /* end MajorTimeStep */
}
...
void lab2_CL_initialize(void)
{
  ...
  /* Setup for data logging */
  {
    ...
    lab2_CL_M->rtwLogInfo = &rt_DataLoggingInfo;
  }

  /* Setup for data logging */
  {
    rtliSetLogXSignalInfo(lab2_CL_M->rtwLogInfo, (NULL));
    rtliSetLogXSignalPtrs(lab2_CL_M->rtwLogInfo, (NULL));
    rtliSetLogT(lab2_CL_M->rtwLogInfo, "tout");
    rtliSetLogX(lab2_CL_M->rtwLogInfo, "");
    rtliSetLogXFinal(lab2_CL_M->rtwLogInfo, "");
    rtliSetLogVarNameModifier(lab2_CL_M->rtwLogInfo, "rt_");
    rtliSetLogFormat(lab2_CL_M->rtwLogInfo, 4);
    rtliSetLogMaxRows(lab2_CL_M->rtwLogInfo, 0);
    rtliSetLogDecimation(lab2_CL_M->rtwLogInfo, 1);
    rtliSetLogY(lab2_CL_M->rtwLogInfo, "");
    rtliSetLogYSignalInfo(lab2_CL_M->rtwLogInfo, (NULL));
    rtliSetLogYSignalPtrs(lab2_CL_M->rtwLogInfo, (NULL));
  }
  ...
  /* Matfile logging */
  rt_StartDataLoggingWithStartTime(lab2_CL_M->rtwLogInfo, 0.0, rtmGetTFinal
    (lab2_CL_M), lab2_CL_M->Timing.stepSize0, (&rtmGetErrorStatus(lab2_CL_M)));

  {
    ...
    lab2_CL_DW.obj.isInitialized = 0;
    lab2_CL_DW.objisempty_e = true;
    lab2_CL_DW.obj.isInitialized = 1;
    varSizes.f1[0] = 1U;
    varSizes.f1[1] = 1U;
    for (i = 0; i < 6; i++) {
      varSizes.f1[i + 2] = 1U;
    ...
    lab2_CL_DW.obj_c.isInitialized = 0;
    lab2_CL_DW.objisempty = true;
    lab2_CL_DW.obj_c.isInitialized = 1;
    ...
    lab2_CL_DW.obj_k.isInitialized = 0;
    lab2_CL_DW.objisempty_m = true;
    lab2_CL_DW.obj_k.isInitialized = 1;
...
void lab2_CL_terminate(void)
{
   ...
   */
  if (lab2_CL_DW.obj.isInitialized == 1) {
    lab2_CL_DW.obj.isInitialized = 2;
  }
   ...
   */
  if (lab2_CL_DW.obj_c.isInitialized == 1) {
    lab2_CL_DW.obj_c.isInitialized = 2;
  }
   ...
   */
  if (lab2_CL_DW.obj_k.isInitialized == 1) {
    lab2_CL_DW.obj_k.isInitialized = 2;
  }
