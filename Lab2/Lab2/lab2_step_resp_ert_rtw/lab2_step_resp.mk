###########################################################################
## Makefile generated for Simulink model 'lab2_step_resp'. 
## 
## Makefile     : lab2_step_resp.mk
## Generated on : Sun Apr 14 10:01:26 2019
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/lab2_step_resp.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/EE103/Desktop/Lab2_G5
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = lab2_step_resp_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/lab2_step_resp.elf
...
DEFINES_STANDARD = -DMODEL=lab2_step_resp -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO
...
%.o : $(START_DIR)/lab2_step_resp_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/lab2_step_resp_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/lab2_step_resp_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
