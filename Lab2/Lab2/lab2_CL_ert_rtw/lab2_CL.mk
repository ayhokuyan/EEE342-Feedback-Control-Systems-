###########################################################################
## Makefile generated for Simulink model 'lab2_CL'. 
## 
## Makefile     : lab2_CL.mk
## Generated on : Sun Apr 14 12:08:49 2019
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/lab2_CL.elf
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = lab2_CL_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/lab2_CL.elf
...
DEFINES_STANDARD = -DMODEL=lab2_CL -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO
...
%.o : $(START_DIR)/lab2_CL_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/lab2_CL_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/lab2_CL_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
