###########################################################################
## Makefile generated for Simulink model 'lab3_step_DM'. 
## 
## Makefile     : lab3_step_DM.mk
## Generated on : Sat Apr 27 10:30:48 2019
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/lab3_step_DM.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/EE103/Desktop/Lab3-G5
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = lab3_step_DM_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/lab3_step_DM.elf
...
DEFINES_ = -D_RTT_USE_SERIAL0_ -DMODEL=lab3_step_DM -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=1 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DRT -DSTACK_SIZE=64 -DMW_TIMERID=1 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=64911 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=115200 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=lab3_step_DM -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO
...
%.o : $(START_DIR)/lab3_step_DM_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/lab3_step_DM_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/lab3_step_DM_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
