...
static emlrtRSInfo emlrtRSI = { 1,     /* lineNo */
  ...
  "C:\\ProgramData\\MATLAB\\SupportPackages\\R2016b\\toolbox\\target\\supportpackages\\arduinobase\\+codertarget\\+arduinobase\\+internal\\ardu"
...
static void cgxe_mdl_start(InstanceStruct_CvDDrgzKCMUBtsbzOngNU *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_CvDDrgzKCMUBtsbzOngNU
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_CvDDrgzKCMUBtsbzOngNU
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_CvDDrgzKCMUBtsbzOngNU *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_CvDDrgzKCMUBtsbzOngNU
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_CvDDrgzKCMUBtsbzOngNU *moduleInstance);
...
static void cgxe_mdl_set_sim_state(InstanceStruct_CvDDrgzKCMUBtsbzOngNU
...
static boolean_T j_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_CvDDrgzKCMUBtsbzOngNU
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_CvDDrgzKCMUBtsbzOngNU(SimStruct *S, int_T tid)
{
  InstanceStruct_CvDDrgzKCMUBtsbzOngNU *moduleInstance =
    (InstanceStruct_CvDDrgzKCMUBtsbzOngNU *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_CvDDrgzKCMUBtsbzOngNU(SimStruct *S)
{
  InstanceStruct_CvDDrgzKCMUBtsbzOngNU *moduleInstance =
    (InstanceStruct_CvDDrgzKCMUBtsbzOngNU *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_CvDDrgzKCMUBtsbzOngNU(SimStruct *S, int_T tid)
{
  InstanceStruct_CvDDrgzKCMUBtsbzOngNU *moduleInstance =
    (InstanceStruct_CvDDrgzKCMUBtsbzOngNU *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_CvDDrgzKCMUBtsbzOngNU(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_CvDDrgzKCMUBtsbzOngNU *moduleInstance =
    (InstanceStruct_CvDDrgzKCMUBtsbzOngNU *)cgxertGetRuntimeInstance(S);
...
static void setSimState_CvDDrgzKCMUBtsbzOngNU(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_CvDDrgzKCMUBtsbzOngNU *moduleInstance =
    (InstanceStruct_CvDDrgzKCMUBtsbzOngNU *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_CvDDrgzKCMUBtsbzOngNU(SimStruct *S)
{
  InstanceStruct_CvDDrgzKCMUBtsbzOngNU *moduleInstance =
    (InstanceStruct_CvDDrgzKCMUBtsbzOngNU *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_CvDDrgzKCMUBtsbzOngNU(SimStruct *S)
{
  InstanceStruct_CvDDrgzKCMUBtsbzOngNU *moduleInstance =
    (InstanceStruct_CvDDrgzKCMUBtsbzOngNU *)calloc(1, sizeof
    (InstanceStruct_CvDDrgzKCMUBtsbzOngNU));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_CvDDrgzKCMUBtsbzOngNU);
  ssSetmdlInitializeConditions(S, mdlInitialize_CvDDrgzKCMUBtsbzOngNU);
  ssSetmdlUpdate(S, mdlUpdate_CvDDrgzKCMUBtsbzOngNU);
  ssSetmdlTerminate(S, mdlTerminate_CvDDrgzKCMUBtsbzOngNU);
...
static void mdlProcessParameters_CvDDrgzKCMUBtsbzOngNU(SimStruct *S)
{
}

void method_dispatcher_CvDDrgzKCMUBtsbzOngNU(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_CvDDrgzKCMUBtsbzOngNU(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_CvDDrgzKCMUBtsbzOngNU(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_CvDDrgzKCMUBtsbzOngNU(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_CvDDrgzKCMUBtsbzOngNU(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: CvDDrgzKCMUBtsbzOngNU.\n"
...
mxArray *cgxe_CvDDrgzKCMUBtsbzOngNU_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_CvDDrgzKCMUBtsbzOngNU_fallback_info(void)
{
