...
#ifndef RTW_HEADER_lab3_step_GM_h_
#define RTW_HEADER_lab3_step_GM_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef lab3_step_GM_COMMON_INCLUDES_
# define lab3_step_GM_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* lab3_step_GM_COMMON_INCLUDES_ */

#include "lab3_step_GM_types.h"
...
} ContinuousStates_lab3_step_GM;

/* State derivatives (auto storage) */
typedef struct {
  real_T Gc_CSTATE;                    /* '<Root>/Gc' */
} StateDerivatives_lab3_step_GM;

/* State disabled  */
typedef struct {
  boolean_T Gc_CSTATE;                 /* '<Root>/Gc' */
} StateDisabled_lab3_step_GM;
...
struct Parameters_lab3_step_GM_ {
...
struct tag_RTM_lab3_step_GM {
  const char_T *errorStatus;
  RTWSolverInfo solverInfo;
  ContinuousStates_lab3_step_GM *contStates;
...
extern Parameters_lab3_step_GM lab3_step_GM_P;

/* Block signals (auto storage) */
extern BlockIO_lab3_step_GM lab3_step_GM_B;

/* Continuous states (auto storage) */
extern ContinuousStates_lab3_step_GM lab3_step_GM_X;

/* Block states (auto storage) */
extern D_Work_lab3_step_GM lab3_step_GM_DWork;

/* Model entry point functions */
extern void lab3_step_GM_initialize(void);
extern void lab3_step_GM_step(void);
extern void lab3_step_GM_terminate(void);

/* Real-time Model object */
extern RT_MODEL_lab3_step_GM *const lab3_step_GM_M;
 ...
 *
 * '<Root>' : 'lab3_step_GM'
 * '<S1>'   : 'lab3_step_GM/DC Motor Plant'
 * '<S2>'   : 'lab3_step_GM/DC Motor Plant/Motorpwm'
 * '<S3>'   : 'lab3_step_GM/DC Motor Plant/Motorpwm/Brake'
 * '<S4>'   : 'lab3_step_GM/DC Motor Plant/Motorpwm/Direction '
 * '<S5>'   : 'lab3_step_GM/DC Motor Plant/Motorpwm/MATLAB Function'
 * '<S6>'   : 'lab3_step_GM/DC Motor Plant/Motorpwm/PWM'
 * '<S7>'   : 'lab3_step_GM/DC Motor Plant/Motorpwm/hardlim'
 */
#endif                                 /* RTW_HEADER_lab3_step_GM_h_ */
