###########################################################################
## Makefile generated for Simulink model 'lab3_step_GM'. 
## 
## Makefile     : lab3_step_GM.mk
## Generated on : Sat Apr 27 09:59:54 2019
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/lab3_step_GM.elf
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = lab3_step_GM_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/lab3_step_GM.elf
...
DEFINES_STANDARD = -DMODEL=lab3_step_GM -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO
...
%.o : $(START_DIR)/lab3_step_GM_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/lab3_step_GM_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/lab3_step_GM_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
