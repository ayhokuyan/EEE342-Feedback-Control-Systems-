###########################################################################
## Makefile generated for Simulink model 'lab_1_position_loop_step'. 
## 
## Makefile     : lab_1_position_loop_step.mk
## Generated on : Sat Mar 02 09:48:24 2019
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/lab_1_position_loop_step.elf
...
PRODUCT_NAME              = lab_1_position_loop_step
MAKEFILE                  = lab_1_position_loop_step.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/EE103/Desktop/Lab1
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = lab_1_position_loop_step_ref.rsp
...
# Toolchain Name:          Arduino AVR v1.6.7 | gmake (64-bit Windows)
# Supported Version(s):    
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/lab_1_position_loop_step.elf
...
INCLUDES_BUILDINFO = -IC:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/arduinobase/include -IC:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/arduinobase/blocks/sfcn/include -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/lab_1_position_loop_step_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/standard -I$(ARDUINO_ROOT)/libraries/Servo/src -IC:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/arduinotarget/registry/../include -IC:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/include
...
DEFINES_ = -D_RTT_USE_SERIAL0_ -DMODEL=lab_1_position_loop_step -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=1 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DRT -DSTACK_SIZE=64 -D_MW_ARDUINO_LOOP_=1 -DMW_ARDUINO_STEP_SIZE=10000 -DMW_ARDUINO_MICROS -D_RTT_BAUDRATE_SERIAL0_=115200 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=lab_1_position_loop_step -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO
...
%.o : $(START_DIR)/lab_1_position_loop_step_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/lab_1_position_loop_step_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/lab_1_position_loop_step_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_SerialWrite.o : C:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/arduinobase/src/MW_SerialWrite.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
